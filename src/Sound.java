...
public class Sound
{
	...
	Sound() throws IOException, FileNotFoundException
	{
	...
	public void gunshotPlayer() throws IOException, FileNotFoundException
	{
		AudioPlayer.player.start(asPlayer);
	}
	public void gunshotEnemy() throws IOException, FileNotFoundException
	{
